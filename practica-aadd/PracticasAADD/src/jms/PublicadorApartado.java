...
public class PublicadorApartado {
	public static void enviar(Valoracion v, int viaje) throws NamingException, JMSException {
		...
		message.setText(v.toString());
		message.setStringProperty("viaje", String.valueOf(viaje));
